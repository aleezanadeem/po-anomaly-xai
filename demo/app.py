...
# Always point to demo/config.yaml by default
...
2. Click **▶ Step** to stream the next batch of events **or** toggle **Auto-step**.
3. New violations/anomalies show as **alerts** in the corner and also appear in **Newest flags**.
...
if not flags_df.empty:
    ...
    if "score" in display_df.columns:
        ...
        display_df["Anomaly Score"] = display_df["Anomaly Score"].map(
